...
<nav class="navbar navbar-expand-lg  bg-dark" data-bs-theme="dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="content.php">JNTHREADS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="content.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " aria-current="true" href="#">Contact Us</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    Shop Women</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="category.php">Crop Shirt</a></li>
                        <!-- <li><a class="dropdown-item" href="category.php">Shirts</a></li> -->
                        <!-- <li><hr class="dropdown-divider"></li> -->
                        <li><a class="dropdown-item" href="category.php">SweatShirts</a></li>
                        <!-- <li><a class="dropdown-item" href="category.php">Jackets</a></li> -->
